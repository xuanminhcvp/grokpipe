...
**A** *(không lời)*
```
Cinematic strings at 76 BPM with fragile, held tension; tremolo violins over slow cello line, a single warm piano note lands mid-way and softens everything, gentle release at the end, Intimate emotional mix — human contact, relief, tenderness after fear, strings, cello, piano, intimate
```
**B** *(không lời)*
```
Emotional orchestral warmth at 80 BPM; solo cello carrying the melody, soft string bed rising underneath, delicate harp touch at the peak, resolving to quiet, Tender cinematic mix — compassion, connection, hands holding on, cello, orchestral, warm, hopeful
```

## SCENE 2: THE MANAGER'S OFFICE

### `V-S2-B1` · 10s — Maya tháo bảng tên đặt xuống bàn Derek
**Cảm xúc:** Mất mát có phẩm giá — đặt xuống thứ mình từng gắn bó

**A** *(không lời)*
```
Cinematic piano lament at 64 BPM with heavy, deliberate pulse; single low piano chords with long silence between, cello enters late and holds, no percussion, ending unresolved, Dark intimate mix — dignity in loss, quiet finality, piano, cello, slow, somber
```
**B** *(không lời)*
```
Sparse orchestral grief at 60 BPM; muted strings under a lone French horn line, deep contrabass swell at the centre, pulling back to near silence, Weighty cinematic mix — something ending, held with grace, orchestral, horn, low, restrained
```

### `V-S2-B2` · 10s — CẦU NỐI S2→S3 — bãi đỗ xe, ngoái nhìn lại biển hiệu
**Cảm xúc:** Chia ly với nơi chốn — nhìn lại lần cuối

**A** *(không lời)*
```
Melancholic americana at 70 BPM; slow acoustic guitar arpeggio with soft pedal steel bends, brushed drums entering halfway, one small lift then fading out, Warm faded mix — leaving, looking back, bittersweet, guitar, pedal steel, acoustic, wistful
```
**B** *(không lời)*
```
Cinematic strings farewell at 68 BPM with gentle walking pulse; viola melody over sustained pad, distant piano echoes, slow decay to nothing, Nostalgic open mix — closing a chapter, quiet ache, strings, viola, ambient, nostalgic
```

### `V-S2-B3` · 10s — TOÀN CẢNH — Maya đi bộ về nhà một mình trên phố dài
**Cảm xúc:** Cô đơn tuyệt đối — đi bộ về nhà một mình

**A** *(không lời)*
```
Sparse ambient loneliness at 62 BPM; lone electric guitar with heavy reverb and slow tremolo, deep bass drone underneath, no drums, endless open space, Desolate wide mix — walking alone, nowhere to go, guitar, ambient, reverb, desolate
```
**B** *(có lời — giọng hát wordless)*
```
Slow indie folk with vocals at 68 BPM; fragile female voice singing wordless legato lines over fingerpicked acoustic guitar, faint cello underneath, no chorus, no lift, Raw intimate mix — solitude, exhaustion, a long walk home, female vocal, folk, acoustic, melancholic
```
...
**A** *(không lời)*
```
Minimal piano at 60 BPM with long pauses; single felt-piano phrase repeating, a low string note entering under it, one breath of silence at the centre, Fragile intimate mix — holding it together alone, piano, minimal, fragile, quiet
```
**B** *(không lời)*
```
...
**Cảm xúc:** Đốm sáng nhỏ giữa bóng tối lớn

**A** *(không lời)*
```
Cinematic ambient night at 58 BPM; deep warm pad under a single distant piano motif, subtle vinyl-like texture, one soft swell then quiet, Nocturnal spacious mix — one light still on, small and stubborn, ambient, piano, night, warm
```
**B** *(không lời)*
```
Slow orchestral night at 62 BPM; muted strings in low register with a lone clarinet line drifting above, gentle harp touches, unresolved fade, Lonely tender mix — a family awake while the world sleeps, orchestral, clarinet, night, intimate
```

## SCENE 4: THE HOSPITAL

### `V-S4-B1` · 6s — MỞ CẢNH — bệnh viện về đêm
**Cảm xúc:** Bệnh viện đêm — lạnh, chờ đợi

**A** *(không lời)*
```
Cold cinematic ambient at 60 BPM; sustained synth drone with metallic sheen, distant heartbeat-like low pulse, faint high string harmonic, no melody, Sterile wide mix — hospital at night, suspended time, ambient, drone, cold, clinical
```
**B** *(không lời)*
```
...
**A** *(không lời)*
```
Cinematic strings at 72 BPM with tentative rising pulse; violin melody hesitating then lifting, warm pad underneath, small hopeful resolve at the end, Bright uncertain mix — not daring to hope yet, strings, violin, hopeful, tentative
```
**B** *(không lời)*
```
Warm ambient hope at 76 BPM; layered synth pad with slow bloom, delicate piano figure repeating, subtle percussion pulse entering late, Open airy mix — a door opening a crack, ambient, piano, hopeful, warm
```
...
**A** *(không lời)*
```
Minimal tension at 68 BPM; single low piano note repeating with long decay, faint tremolo string underneath, breath-like pauses, no resolution, Claustrophobic intimate mix — hands gripping, holding it in, piano, strings, minimal, tense
```
**B** *(không lời)*
```
Ambient held breath at 64 BPM; sustained cello drone with subtle pitch drift, tiny high bell tones, no rhythm at all, Airless close mix — a moment too big to react to, cello, ambient, sparse, suspended
```

### `V-S6-B3` · 6s — CẦU NỐI — Maya trong thang máy kính đi xuống
**Cảm xúc:** Choáng váng xen hy vọng — thế giới vừa lật

**A** *(không lời)*
```
Cinematic ambient at 74 BPM; warm pad rising slowly with distant piano echoes, soft string swell mid-way, gentle unresolved fade, Weightless mix — descending, processing something huge, ambient, piano, spacious, dazed
```
**B** *(không lời)*
```
Emotional strings at 78 BPM with gentle floating pulse; violin line drifting upward over sustained low strings, harp glissando at the peak, soft landing, Luminous cinematic mix — disbelief turning into hope, strings, harp, luminous, hopeful
```

### `V-S6-B4` · 6s — TOÀN CẢNH — thành phố nhìn từ vách kính tầng cao, Maya nhỏ bên cửa sổ
**Cảm xúc:** Cả một thế giới vừa mở ra

**A** *(không lời)*
```
Cinematic orchestral wonder at 76 BPM; strings building in wide sustained layers, French horn line entering at the peak, soft cymbal shimmer, resolving open, Expansive bright mix — a horizon appearing, orchestral, horn, expansive, awed
```
**B** *(không lời)*
```
...
**Cảm xúc:** Nhẹ nhõm và tự hào thầm lặng

**A** *(không lời)*
```
Warm cinematic strings at 78 BPM with gentle forward pulse; violin melody rising into sunlight, soft brass pad underneath, light percussion, resolving warmly, Bright open mix — walking out with your dignity intact, strings, brass, warm, uplifting
```
**B** *(không lời)*
```
...
### `V-S10-B1` · 6s — Maya & Denise cùng cúi vào sách trong thư viện
**Cảm xúc:** Tình bạn ấm áp — hai người cùng vượt khó

**A** *(không lời)*
```
Warm indie acoustic at 88 BPM with light bouncing pulse; fingerpicked guitar with soft glockenspiel accents, brushed drums, gentle and unhurried, Cosy intimate mix — late-night study, easy friendship, guitar, glockenspiel, acoustic, warm
```
**B** *(không lời)*
```
Playful minimal piano at 92 BPM; light staccato piano motif over soft upright bass, subtle shaker groove, small smiling lift, Bright cosy mix — shared exhaustion, laughing about it, piano, bass, light, friendly
```
...
**A** *(không lời)*
```
Ambient night at 56 BPM; deep warm drone with a single distant piano note repeating, faint wind texture, no rhythm, endlessly patient, Nocturnal wide mix — one light burning against the dark, ambient, piano, night, solitary
```
**B** *(không lời)*
```
Minimal cinematic at 62 BPM; sparse cello line under sustained pad, tiny bell tones marking time, one slow swell then quiet, Lonely determined mix — the invisible hours nobody sees, cello, ambient, sparse, resolute
```

## SCENE 12: SAVEMORE — ONE YEAR LATER

### `V-S12-B1` · 6s — Tanya nhìn theo bóng Maya rời siêu thị
**Cảm xúc:** Hối tiếc và một quyết tâm nhỏ

**A** *(không lời)*
```
Reflective strings at 70 BPM; solo cello melody over soft sustained pad, faint piano notes, gentle unresolved close, Intimate melancholic mix — regret, and a promise made quietly, cello, strings, reflective, tender
```
**B** *(không lời)*
```
Warm ambient resolve at 74 BPM; layered pads with a slow rising figure, brushed percussion entering late, small hopeful lift at the end, Soft hopeful mix — deciding to be better next time, ambient, warm, gentle, resolving
```

## SCENE 13: HELEN'S GARDEN

### `V-S13-B1` · 6s — MỞ CẢNH — vườn nhà Helen, nắng chiều
**Cảm xúc:** Bình yên — khu vườn nắng chiều

**A** *(không lời)*
```
Pastoral ambient at 68 BPM; warm strings with soft flute line, gentle harp arpeggios, birdsong-like textures, no drums, Serene golden mix — an afternoon garden, safety, ease, strings, flute, harp, pastoral
```
**B** *(không lời)*
```
...
**Cảm xúc:** Thanh thản — được che chở giữa không gian rộng

**A** *(không lời)*
```
Cinematic pastoral at 70 BPM; wide string bed with a flute melody floating above, soft harp and gentle percussion, expansive and calm, Open golden mix — small and safe in a large kind world, orchestral, flute, pastoral, serene
```
**B** *(không lời)*
```
Ambient orchestral peace at 66 BPM; slow-blooming pads with distant piano, subtle string swell, no percussion, endlessly open, Panoramic tranquil mix — stillness, belonging, ambient, orchestral, spacious, peaceful
```

## SCENE 14: THE HOSPITAL HALLWAY

### `V-S14-B1` · 10s — CẦU NỐI — hai bà cháu đi dọc hành lang bệnh viện
**Cảm xúc:** Tin tưởng — hai bà cháu đi về phía ánh sáng

**A** *(không lời)*
```
Warm cinematic strings at 74 BPM with gentle walking pulse; cello melody with violin answering above, soft brass pad, slow warm resolution, Golden intimate mix — family, being held up, walking on, strings, cello, warm, tender
```
**B** *(có lời — humming nền)*
```
Gentle gospel-tinged soul at 76 BPM; warm Rhodes piano with soft organ pad, brushed drums, wordless female humming low in the mix, slow uplifting build, Warm analog mix — generational love, quiet faith, rhodes, organ, soul, warm
```

## SCENE 15: GRADUATION DAY

### `V-S15-B1` · 6s — MỞ CẢNH — mũ tốt nghiệp tung lên trời
**Cảm xúc:** Vỡ òa — mũ tung lên trời

**A** *(không lời)*
```
Triumphant orchestral at 104 BPM with bright driving pulse; full strings and brass rising together, timpani rolls and cymbal crashes, wide euphoric peak, Bright celebratory mix — everything paid off, joy released, orchestral, brass, triumphant, euphoric
```
**B** *(có lời — hook wordless)*
```
...
**A** *(không lời)*
```
Cinematic orchestral pride at 88 BPM; strings building in wide layers over steady timpani, brass entering at the peak, resolving bright and full, Expansive proud mix — one small figure who came the furthest, orchestral, brass, proud, expansive
```
**B** *(không lời)*
```
...
**A** *(không lời)*
```
Anticipatory ambient at 72 BPM; warm pads with a simple repeating piano motif, soft string swell building gently, no resolution yet, Bright expectant mix — everything ready, waiting to begin, ambient, piano, expectant, warm
```
**B** *(không lời)*
```
Cinematic morning at 76 BPM; light strings with delicate harp arpeggios, soft brass pad underneath, slow patient build, Sunlit open mix — the calm before something good, orchestral, harp, morning, hopeful
```

### `V-S18-B3` · 6s — TOÀN CẢNH — khu Riverdale, nơi cô lớn lên
**Cảm xúc:** Gốc rễ — khu phố nơi cô lớn lên

**A** *(không lời)*
```
Nostalgic americana at 70 BPM; slide guitar with warm organ pad, brushed drums, upright bass, unhurried and lived-in, Golden faded mix — the neighbourhood that raised her, slide guitar, organ, americana, nostalgic
```
**B** *(không lời)*
```
Warm soul instrumental at 74 BPM; Rhodes piano with soft horn section, laid-back drum groove, gentle bass line, Analog vintage mix — community, roots, coming home, rhodes, horns, soul, nostalgic
```
...
**A** *(không lời)*
```
Bright orchestral fanfare at 96 BPM; brass line leading over strings and timpani, cymbal accents, short confident peak, Celebratory clean mix — a door opening for everyone, orchestral, brass, fanfare, celebratory
```
**B** *(không lời)*
```
Uplifting modern cinematic at 100 BPM; bright synth arpeggios with live drums and warm string pad, quick joyful lift, Clean contemporary mix — a beginning, ribbon cut, doors open, synth, strings, uplifting, bright
```

### `V-S19-B3` · 10s — TOÀN CẢNH — cả cộng đồng trước phòng khám ngày khai trương
**Cảm xúc:** Hào hùng — cả một cộng đồng

**A** *(không lời)*
```
Cinematic orchestral anthem at 92 BPM with wide confident pulse; full strings and brass in layered build, timpani and cymbals, expansive triumphant peak holding, Grand cinematic mix — one person's choice becoming a community, orchestral, brass, anthemic, triumphant
```
**B** *(có lời — hợp xướng)*
```
Soul-gospel anthem at 88 BPM; full choir singing wordless rising harmonies over organ, bass and live drums, big open-hearted climax, Warm powerful mix — collective joy, a neighbourhood lifted, choir, gospel, organ, anthemic
```
...
**A** *(không lời)*
```
Serene cinematic at 70 BPM; sustained warm strings with a simple piano motif, soft harp, slow luminous resolution, Sunlit peaceful mix — arrival, stillness, earned calm, strings, piano, harp, serene
```
**B** *(không lời)*
```
